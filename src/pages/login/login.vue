    ...
    <div class="layadmin-user-login layadmin-user-display-show" ref="pgCanvas">
        ...
        <div class="layadmin-user-login-main">
            ...
            <div class="layadmin-user-form layui-icon-username layui-icon">
                <input type="text" placeholder="用户名" class="login_txtbx" v-model="form.loginName" @keyup.enter="login">
            </div>

            <div class="layadmin-user-form layui-icon layui-icon-password">
                <input type="password" placeholder="密码" class="login_txtbx" v-model="form.password" @keyup.enter="login">
            </div>
