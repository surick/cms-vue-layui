<template>
    <Card title="公司文化" icon="layui-icon-fonts-code" @icon-click="showDoc('富文本', 'editor')">
        <div class="layui-btn-container">
            <button class="layui-btn" @click="updateCulture()">保存英文</button>
            <button class="layui-btn" @click="updateCnCulture()">保存中文</button>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            updateCulture() {
                About.updateCulture(this, 2, this.instance.getContent()).then(res => {
                    if (res.success) {
                        this.$layer.msg('修改成功');
            ...
            updateCnCulture() {
                About.updateCnCulture(this, 2, this.instance.getContent()).then(res => {
                    if (res.success) {
                        this.$layer.msg('修改成功');
                        this.$router.push('/about/culture');
                    }
